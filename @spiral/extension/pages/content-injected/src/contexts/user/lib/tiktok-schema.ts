...
function createBaseEnterRoomMessage(): EnterRoomMessage {
  return { roomId: "0", field4: 0, role: "", cursor: "", field7: 0, field9: "", field10: 0 };
}

export const EnterRoomMessage: MessageFns<EnterRoomMessage> = {
  encode(message: EnterRoomMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.roomId !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EnterRoomMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEnterRoomMessage();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): EnterRoomMessage {
    return {
      ...
      field9: isSet(object.field9) ? globalThis.String(object.field9) : "",
      field10: isSet(object.field10) ? globalThis.Number(object.field10) : 0,
    };
  },

  toJSON(message: EnterRoomMessage): unknown {
    const obj: any = {};
    if (message.roomId !== "0") {
  ...
  create<I extends Exact<DeepPartial<EnterRoomMessage>, I>>(base?: I): EnterRoomMessage {
    return EnterRoomMessage.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EnterRoomMessage>, I>>(object: I): EnterRoomMessage {
    const message = createBaseEnterRoomMessage();
